            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item mx-5 active">
                        <a class="nav-link" href="<?php echo base_url('index.php/barang/index')?>">Inventori</a>
                    </li>
                    <li class="nav-item mx-5">
            ...
            <div class="row">
                <div class="col-md-2 bg-light pt-2 sidebar">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" href="<?php echo base_url('index.php/barang/index')?>">Rangkuman</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url('index.php/barang/daftar_barang')?>">Daftar Produk</a>
                        </li>
                        <li class="nav-item">
